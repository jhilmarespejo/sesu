...
class SalaTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('Centroinfantil', [
            'foreignKey' => 'centroinfantil_id',
            'joinType' => 'INNER'
        ]);
        $this->hasMany('Administrativo', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Ambiente', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Carpetaedus', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Carpetaninos', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Cocina', [
            'foreignKey' => 'sala_id'
        ...
        $this->hasMany('Educadoras', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Eduinicial', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Higiene', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Infraestructura', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Ninos', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Nutricion', [
            'foreignKey' => 'sala_id'
        ]);
        $this->hasMany('Salud', [
            'foreignKey' => 'sala_id'
